...
วิเคราะห์แต่ละตัว 6 ด้าน: Business Quality, Financial Health, Growth Consistency, Dividend Sustainability, Valuation, DCA Suitability (⭐⭐⭐/⭐⭐/⭐) + สรุป (น่าสะสม/ถือต่อ/ระวัง)
...
สั้นๆ ตัวละ 2-3 บรรทัด — ธุรกิจอะไร + จุดเด่นเบื้องต้น + ⭐ DCA rating

### 4. Watch Out (ตัวที่ signal น่ากังวล ทั้งใน watchlist และ top_candidates — เช่น YIELD_TRAP, DATA_WARNING, D/E สูงผิดปกติ)
